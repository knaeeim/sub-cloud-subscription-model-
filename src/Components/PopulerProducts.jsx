...
const PopulerProducts = () => {
    ...
    return (
        <div className="mt-10">
            <h1 className="text-3xl text-center font-bold mb-5">Browse Our <span className="text-[#092327]"> Most Populer Products</span> from All Category.. <br /> and Buy a Suitable Subscription for you...</h1>
            <div>
